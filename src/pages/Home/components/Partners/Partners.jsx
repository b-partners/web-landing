...
import Bred from '../../assets/img/partners/bred.png';
  ...
  return (
    <section className="partners">
      ...
      <div className="bd-container partners__container">
        <ImageCard imageSrc={Bred} alt="Bred logo" />
        <ImageCard imageSrc={Bridge} alt="Bridge logo" />
        <ImageCard imageSrc={Fintecture} alt="Fintecture logo" />
      </div>
      <div className="bd-container partners__container">
        <ImageCard imageSrc={Founders} alt="Founders logo" />
        <ImageCard imageSrc={Systematic} alt="Systematic logo" />
        <ImageCard imageSrc={Pepiniere} alt="Pepiniere logo" styles={{ marginTop: '-2.2rem' }} />
      </div>
    </section>
  );
}
