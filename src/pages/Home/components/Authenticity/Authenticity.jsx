    ...
    <section className="mobile section">
      ...
      <div className="mobile__task bd-container">
        <h2 className="mobile__title">
          <b>
            Votre mobile s'occupe de gérer les tâches administratives,
            <br /> financières et commerciales{' '}
          </b>
        ...
        <div className="mobile__task__container">
          <div className="mobile__task__info">
            ...
            <p style={{ textAlign: 'justify' }}>
              Aujourd'hui les artisans perdent entre 30% à 40% de leur temps sur des tâches administratives, financières
              ou de la prospection laborieuse qui les éloignent de leur vrai métier. BPartners est une application
              tout-en-un construite avec les artisans pour les artisans avec un but unique:{' '}
              <b>
                laisser votre téléphone gérer ces tâches ardues pendant que vous vous reconcentrez sur la satisfaction
                de vos clients.
              </b>
            </p>
          </div>
