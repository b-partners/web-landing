        ...
        <>
            <section className='bp-tagline-section'>
                ...
                <div className="share__container  bd-container">
                    ...
                    />
                    <ShareCard
                        cardText="Générez un rapport d'analyse, avec votre proposition commerciale."
                        imgSrc={Bill}
                    />
                    <ShareCard
                        cardText="Priorisez et programmez vos interventions."
                        imgSrc={Euro}
                    />
                    <ShareCard
                        cardText="Facturez et encaissez en 1 clic."
                        imgSrc={Bank}
                    />
                </div>
            </section>
                    ...
                    <div className='mobile__task__container'>
                        <div className='mobile__task__info'>
                            ...
                            <p style={{textAlign: 'justify'}}>
                                Face aux enjeux climatiques, la recrudescence des intempéries engendre une surcharge
                                de travail considérable pour les couvreurs français, qui <b>passent 20% à 30% de leur
                                temps à se rendre chez des prospects pour faire des devis.</b>
                            </p>
                            <p style={{textAlign: 'justify'}}>
                                Issue de la recherche académique française, BPartners a développé <b>une IA reproduisant
                                les étapes d'analyses des toitures d'un couvreur sur des images aériennes haute
                                définition
                                à 5 cm de précision</b>, permettant d'avoir les mesures, le chiffrage et l'urgence de
                                l'intervention.
                            </p>
                            <b>- Moins de déplacements pour faire des devis techniques</b><br/>
