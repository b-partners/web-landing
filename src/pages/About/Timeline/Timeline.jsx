...
export function Timeline() {
  return (
    <div className="timeline">
      ...
      />
      <Polygone description="Création de la société en début 2023, lancement des développements IT." color="rgba(165, 58, 106, 1)" position="polygone-down" />
      <Polygone description="Interviews des artisans testeurs." color="rgba(175, 79, 122, 1)" position="polygone-up" />
      <Polygone description="Juin 2023 : Commercialisation auprès des artisans." color="rgba(197, 129, 161, 1)" position="polygone-down" />
      <Polygone
