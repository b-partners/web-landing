    ...
    <Box sx={{ mb: '50px', '& .carousel-root': { minHeight: '420px' } }}>
      ...
      >
        <TestimonialItem
          ...
          content={`"Issue de la recherche académique française, BIRDIA a développé une IA reproduisant les étapes d'analyses des toitures d'un couvreur sur des images aériennes haute définition à 5 cm de précision, permettant d'avoir les mesures, le chiffrage et l'urgence de l'intervention."`}
        >
        ...
        <TestimonialItem
          ...
          content={`"La startup BIRDIA a conçu une application sous forme d'un assistant qui prend de la hauteur et analyse vos toitures sur image HD."`}
        >
        ...
        <TestimonialItem
          ...
          content={`"BIRDIA fait partie des 10 nouveaux membres ayant rejoint le Pôle en mars 2023, une technologie innovante au service des collectivités, assureurs et artisans couvreurs !"`}
        />
        <TestimonialItem
          linkSx={linkSx}
          ...
          content={`"BIRDIA est lauréat du Concours Régional Ile-de-France de Création d'Entreprise organisé par la BRED & la Chambre de Commerce de l'Industrie de l'Ile-de-France . Tout ce dont un artisan couvreur a besoin se trouve dans BIRDIA."`}
        />
      </Carousel>
    </Box>
  );
