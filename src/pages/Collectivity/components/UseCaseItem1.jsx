        ...
        <aside>
          <div className="box-img-col">
            <ol className="zan_order-list">
              ...
              <li>Mesure de l'artificialisation et déduction du potentiel de désimperméabilisation de la zone.</li>
            ...
            <div className="usecase-table">
              <div className="offer__table-row bd-container">
                ...
                <div className="offer__table-first__column usecase-table-column">
                  <div className="table-body-cell">
                    <b className="logo-color">Calcul du taux d'artificialisation de la dalle</b>
                  </div>
                  <div className="table-body-cell">
                    <p>86%</p>
                  </div>
                ...
                <div className="offer__table-first__column usecase-table-column">
                  <div className="table-body-cell">
                    <b className="logo-color">Calcul du taux de perméabilité de la dalle</b>
                  </div>
                  <div className="table-body-cell">
                    <p>14%</p>
                  </div>
