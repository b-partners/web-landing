    ...
    return (
        <section className='partners_collectivity bd-container' id='description'>
            ...
            <ul className='award_list'>
                <li>Entreprise by Commissariat à l’Energie Atomique “CEA”, labélisée French Tech Seed et Deeptech par
                    BPI
            ...
            <div className='partners_logo'>
                <div className='partners-item1'>
                    ...
                    <div className='partners_img_container'>
                        <img src={CEA} alt='Fintecture Logo'
                             style={{objectFit: 'contain', maxWidth: '200px'}}/>
                        <img src={FrenchTech} alt='AwsStartups Logo'
                             style={{objectFit: 'contain', maxWidth: '110px'}}/>
                        <img src={IMT} alt='AwsStartups Logo'
                             style={{objectFit: 'contain', maxWidth: '200px'}}/>
                    </div>
                </div>
                <div className='partners-item2'>
                    ...
                    <div className='partners_img_container'>
                        <img src={DeepTech} alt='AwsStartups Logo'
                             style={{objectFit: 'contain', maxWidth: '200px'}}/>
                        <img src={CCI} alt='AwsStartups Logo'
                             style={{objectFit: 'contain', maxWidth: '200px'}}/>
                    </div>
                </div>
            </div>
