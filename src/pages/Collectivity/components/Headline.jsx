...
export function Headline() {
    ...
    return (
        <section className="headline bd-container" id="description">
            <h2 className="headline__title">Détectez et raisonnez par IA pour gagner {matches && <br/>} en précision et
                en réactivité.</h2>

            <div className='headline_content'>
                <article className='headline_article'>
                    <h3 className="headline__subtitle">Intelligence artificielle issue de la recherche française,
                        souveraine, entraînée<br/>sur l'ensemble du
                        territoire français.</h3>
                    <p className="headline__paragraph">BPartners est une startup issue de la recherche française.
                        Labélisée
                        entreprise DeepTech pour avoir
                        conçu
                        un outil de détection et mesure d’objets pour les artisans pour leur simplifier la vie.
                        Cette technologie a été étendue aux collectivités et grandes groupes pour répondre à leurs
                        besoins
                        de
                    ...
                    <p className="headline__paragraph">
                        La technologie repose sur de la détection automatisée des objets, l'extraction pour y appliquer
                        des
                        raisonnements
