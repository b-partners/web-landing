                ...
                <div className='offer_collectivity'>
                    <div className='offer_collectivity__item'>
                        ...
                        <ul className='offer_item-content'>
                            <li>Détectez et qualifiez les objets déjà disponible dans la bibliothèque BPartners (bâti, végétation, sol artificialisé,
                                signalisation au sol, installations solaires, zones de débroussaillages, etc...).
                            </li>
                        </ul>
                    ...
                    <div className='offer_collectivity__item'>
                        ...
                        <ul className='offer_item-content'>
                            ...
                            <li>Détectez et qualifiez les objets déjà disponible dans la bibliothèque BPartners (bâti, végétations, sol artificialisé,
                                signalisation au sol, installations solaires, zones de débroussaillages, etc...).
                            </li>
                        </ul>
                        <span className='add-object'>+ AJOUTEZ vos propres objets d‘intérêts et vos propres raisonnements.</span>
