export default {
  ...
  hero: {
    title: 'Diagnostic performance toiture : évaluer l’efficacité et anticiper les améliorations nécessaires\n',
    items: [
      'Analyse de l’efficacité thermique, étanchéité et résistance de la toiture.',
      'Permet d’identifier les faiblesses et les zones à renforcer.',
      'Recommandé avant rénovation ou pour optimiser la durabilité du bâtiment.',
    ],
  },
  ...
  analyse: {
    ...
    information: [
      {
        title: 'Pourquoi un diagnostic performance toiture est essentiel ?',
        description: '➤ Mesurer la résistance, l’efficacité énergétique et l’étanchéité de la couverture.',
      },
      {
        title: 'Comment se déroule un diagnostic performance toiture ?',
        description: '➤ Inspection visuelle, contrôles techniques et relevés adaptés aux caractéristiques du toit.',
      },
      {
        title: 'Que faire après un diagnostic performance toiture ?',
        description: '➤ Planifier des réparations ciblées et améliorer les performances globales du toit.',
      },
    ],
    explication:
  ...
  roofDiagnostics: {
    title: 'Comprendre les enjeux à long terme d’un diagnostic performance toiture',
    description1:
      'Un diagnostic performance toiture permet de garantir la fiabilité et l’efficacité de la couverture sur le long terme. Il évalue l’isolation, l’étanchéité et la résistance des matériaux, tout en détectant les signes d’usure prématurée. Cette analyse préventive aide à réduire les risques d’infiltration, à limiter les pertes énergétiques et à prolonger la durée de vie du toit. En anticipant les interventions nécessaires, elle favorise un entretien maîtrisé et contribue à préserver le confort intérieur ainsi que la valeur patrimoniale du bâtiment.',
    description2:
