export default {
  ...
  hero: {
    title: 'Diagnostic de toiture par examen visuel : une inspection simple mais efficace',
    items: [
      'Évaluation de l’état général de la toiture à l’œil nu, sans matériel lourd.',
      'Permet de repérer rapidement les défauts visibles et signes d’infiltration.',
      'Recommandé en entretien régulier ou en première étape d’un contrôle approfondi.',
    ],
  },
  ...
  analyse: {
    ...
    information: [
      {
        title: 'Pourquoi un diagnostic de toiture par examen visuel est utile ?',
        description: 'Détecter rapidement les anomalies apparentes pour intervenir avant l’aggravation des dommages.',
      },
      {
        title: 'Comment se réalise un diagnostic de toiture par examen visuel ?',
        description: 'Observation méthodique de la couverture, des fixations et des points sensibles à l’usure.',
      },
      {
        title: 'Que faire après un diagnostic de toiture par examen visuel ?',
        description: 'Décider d’une réparation ciblée ou programmer un contrôle technique plus approfondi.',
      },
    ],
    explication:
  ...
  roofDiagnostics: {
    title: 'Comprendre les enjeux à long terme d’un diagnostic de toiture par examen visuel',
    description1:
      'Un diagnostic de toiture par examen visuel constitue la première étape d’un entretien préventif efficace. Il permet de repérer les signes évidents de dégradation, comme des tuiles fissurées, des éléments déplacés ou des traces d’infiltration. Bien que limité aux défauts visibles, ce contrôle rapide aide à prioriser les interventions et à éviter une aggravation des problèmes. Sur le long terme, il contribue à prolonger la durée de vie de la couverture, à réduire les coûts d’entretien et à maintenir la sécurité du bâtiment. Un suivi visuel régulier reste une base solide pour la protection de la toiture.',
    description2:
