export default {
  ...
  hero: {
    title: 'Diagnostic toiture et laine de verre : contrôler l’étanchéité et la performance isolante',
    items: [
      'Vérification conjointe de l’état de la toiture et de l’isolation en laine de verre.',
      'Détection des infiltrations pouvant altérer l’efficacité thermique et provoquer des dégradations.',
      'Étape recommandée avant rénovation énergétique ou en cas de perte de performance isolante.',
    ],
  },
  ...
  analyse: {
    ...
    information: [
      {
        title: 'Pourquoi un diagnostic toiture et laine de verre est essentiel ?',
        description: 'Prévenir infiltrations et humidité qui réduisent l’efficacité isolante de la laine de verre.',
      },
      {
        title: 'Comment se déroule un diagnostic toiture et laine de verre ?',
        description: 'Inspection de la couverture, contrôle des combles et vérification de l’isolation posée.',
      },
      {
        title: 'Que faire après un diagnostic toiture et laine de verre ?',
        description: 'Réparer la couverture, remplacer la laine de verre humide et renforcer l’isolation.',
      },
    ],
    explication:
  ...
  roofDiagnostics: {
    title: 'Comprendre les enjeux à long terme d’un diagnostic toiture et laine de verre',
    description1:
      'Un diagnostic toiture et laine de verre est indispensable pour garantir la performance énergétique et la durabilité du bâtiment. Une toiture défaillante entraîne rapidement des infiltrations qui humidifient l’isolant, réduisant fortement son efficacité thermique et favorisant l’apparition de moisissures. Ce contrôle permet d’identifier les zones à risque, d’assurer la continuité de l’étanchéité et de maintenir des conditions optimales d’isolation. Sur le long terme, il contribue à préserver le confort intérieur, à réduire les dépenses énergétiques et à éviter des remplacements prématurés coûteux de l’isolant et de la toiture.',
    description2:
