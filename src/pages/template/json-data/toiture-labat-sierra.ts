export default {
  ...
  hero: {
    title: 'Diagnostic de toiture Labat Sierra : évaluer et protéger efficacement votre couverture',
    items: [
      'Évaluation complète de l’état de la toiture par l’entreprise Labat Sierra.',
      'Permet de repérer les signes d’usure, infiltrations et défauts structurels.',
      'Recommandé en entretien préventif ou avant travaux de rénovation.',
    ],
  },
  ...
  analyse: {
    ...
    information: [
      {
        title: 'Pourquoi un diagnostic de toiture Labat Sierra est important ?',
        description: 'Identifier précisément les défauts pour planifier des actions de maintenance ciblées.',
      },
      {
        title: 'Comment se déroule un diagnostic de toiture Labat Sierra ?',
        description: 'Inspection méthodique avec relevés techniques pour établir un rapport d’état complet.',
      },
      {
        title: 'Que faire après un diagnostic de toiture Labat Sierra ?',
        description: 'Mettre en œuvre les réparations nécessaires et programmer un suivi régulier.',
      },
    ],
    explication:
  ...
  roofDiagnostics: {
    title: 'Comprendre les enjeux à long terme d’un diagnostic de toiture Labat Sierra',
    description1:
      'Un diagnostic de toiture Labat Sierra permet d’obtenir une évaluation fiable et détaillée de la couverture. Il aide à anticiper les problèmes liés à l’usure des matériaux, aux infiltrations ou aux défauts de fixation. En intervenant avant que les dégradations ne s’aggravent, il est possible de prolonger la durée de vie de la toiture, de réduire les coûts d’entretien et de préserver la valeur du bien immobilier. Sur le long terme, cette approche préventive assure la protection de la structure et le confort des occupants.',
    description2:
