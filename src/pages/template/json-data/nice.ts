export default {
  route: 'paris',
  metaTitle: 'BIRDIA, l’IA qui analyse vos toitures sur images HD',
  metaDescription: "Mesures précises, détection d'anomalies (usures, moisissures...), et gestion de dossiers. Gagnez du temps, optimisez vos interventions !",
  ...
  analyse: {
    ...
    information: [
      { title: 'Analyse et rapports en temps réel', description: 'Analyse en temps réel pour prioriser vos interventions et gagner du temps.' },
      {
  ...
  roofDiagnostics: {
    title: 'Diagnostique toiture',
    description1:
      "Chez Birdia.fr, nous vous proposons un diagnostic toiture complet pour évaluer l’état de votre couverture, repérer les éventuelles infiltrations, dégradations ou défauts d’isolation. Ce service essentiel vous permet d’anticiper les travaux, d'éviter les mauvaises surprises et de prolonger la durée de vie de votre toiture. Nos experts interviennent rapidement, avec un rapport détaillé et des recommandations claires.",
    description2:
