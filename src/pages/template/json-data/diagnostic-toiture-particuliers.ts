export default {
  ...
  hero: {
    title: 'Diagnostic de toiture pour particuliers : protéger son habitat et anticiper les réparations\n',
    items: [
      'Évaluation complète de l’état du toit adaptée aux besoins des propriétaires particuliers.',
      'Permet de détecter infiltrations, fissures et signes d’usure des matériaux.',
      'Recommandé en entretien préventif ou avant travaux importants.',
    ],
  },
